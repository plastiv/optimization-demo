...
namespace Optimization.Tests
{
    ...
    class TestUniformMethod
    {
        ...
        public void TestMethodWork1()
        {
            ...
            Assert.AreEqual(3,Uniform.GetMinimum(ovf, a0, b0, 0.01),0.01);
        }
        ...
        public void TestMethodWork2()
        {
            ...
            Assert.AreEqual(1.23, Uniform.GetMinimum(ovf, a0, b0, 0.01), 0.01);
        }
        ...
        public void TestMethodWork3()
        {
            ...
            Assert.AreEqual(1.6, Uniform.GetMinimum(ovf, a0, b0, 0.01), 0.01);
        }
        ...
        public void TestMethodWork4()
        {
            ...
            Assert.AreEqual(4, Uniform.GetMinimum(ovf, a0, b0, 0.01), 0.01);
        }
